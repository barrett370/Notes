\message{ !name(verif-revisionnotes.tex)}\documentclass{article}
...
\message{ !name(verif-revisionnotes.tex) !offset(-3) }
...
\message{ !name(verif-revisionnotes.tex) !offset(-150) }
